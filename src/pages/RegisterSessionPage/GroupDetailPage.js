...
const GroupDetailPage = ({ navigation, route }) => {
    const APP_GROUP_ID = 'group.com.bros.volleyballproject';
        ...
        <View style={styles.main_container}>
            ...
            <View style={{ zIndex: 1 }}>
                <View style={styles.header}>
                    ...
                    <Text style={styles.header_text}>球館資訊</Text>
                </View>
            </View>
            <View style={styles.topPortionContainer}>
                <Image 
                    style={styles.topImage}
                    source={{uri: "https://lh3.googleusercontent.com/p/AF1QipMUXLPTJ7zPTsxfqNTf-jbY1hq8iwAj2rpIp4Aq=s1360-w1360-h1020-rw"}}
                />
                <View style={styles.titleRow}>
                    ...
                    />
                    <Text style={styles.title}>藍雀牌球館</Text>
                </View>
            </View>

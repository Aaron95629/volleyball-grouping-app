...
const VerifyingRegister = ({route, navigation}) => {

    const { filteredRegister } = route.params;
    ...
    return (
        <View style = {styles.container}>
            ...
            <View style = {styles.header}>
                ...
                <Text style = {styles.header_text}> 審核中報名 </Text>
            </View>
            <ScrollView> 
                {filteredRegister.map((session) => {
                    return (
                        <SessionBox
                            key={session.id}
...
export default VerifyingRegister;

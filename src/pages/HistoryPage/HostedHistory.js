...
const HostedHistory = ({route, navigation}) => {

    const { hostedHistory } = route.params;
    ...
    return (
        <View style = {styles.container}>
            ...
            <View style = {styles.header}>
                ...
                <Text style = {styles.header_text}> 發起紀錄 </Text>
            </View>
            <ScrollView> 
                {hostedHistory.map((session) => {
                    return (
                        <SessionBox
                            key={session.id}
